...
3.  the `.Rmd/.QMD` file you use to analyze your data,
4.  a link to your presentation slides (Google slides) or powerpoint file, and
5.  a short presentation the last day of class.
